...
{
    soft_iic_write_8bit_register(&oled_iic,
        mode ? 0x40U : 0x00U, dat);
}
...
void OLED_Clear(void)
{
    static const uint8_t blank_line[128] = {0};
    uint8_t page;
    ...
    for (page = 0; page < 8; page++)
    {
        ...
        soft_iic_write_8bit_registers(&oled_iic, 0x40U,
            blank_line, sizeof(blank_line));
    }
}
